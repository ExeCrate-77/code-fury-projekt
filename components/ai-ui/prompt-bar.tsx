...
type Shader = { destroy: () => void };
const ACCENTS = { red: "#f43f5e", orange: "#f97316", yellow: "#eab308", green: "#22c55e", cyan: "#06b6d4", blue: "#3b82f6", purple: "#a855f7" };
const accentChain = (colors: string[]) => colors;
const createShader = (_options: unknown): Shader => ({ destroy: () => undefined });
const playSweep = (_shader: Shader, _options: unknown) => ({ done: Promise.resolve() });
