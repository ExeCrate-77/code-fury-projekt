...
const machineClassName =
  "relative isolate w-full overflow-hidden rounded-[var(--printer-radius)] border border-foreground/30 bg-[#171b1f] p-[var(--printer-inset)] pb-8 shadow-[0_20px_36px_-20px_rgba(0,0,0,.8),0_6px_14px_-8px_rgba(0,0,0,.55),inset_0_1px_0_rgba(255,255,255,.12),inset_0_-1px_0_rgba(0,0,0,.7)] [--printer-inner-radius:calc(var(--printer-radius)_-_var(--printer-inset))] [--printer-inset:0.75rem] [--printer-radius:1.5rem] before:pointer-events-none before:absolute before:inset-0 before:z-0 before:rounded-[inherit] before:bg-[url('/textures/plastic-noise.svg')] before:bg-[length:180px_180px] before:bg-repeat before:opacity-20 before:mix-blend-screen before:content-['']";
